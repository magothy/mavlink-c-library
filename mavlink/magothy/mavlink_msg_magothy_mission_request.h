...
#define MAVLINK_MSG_ID_MAGOTHY_MISSION_REQUEST_LEN 2
#define MAVLINK_MSG_ID_MAGOTHY_MISSION_REQUEST_MIN_LEN 2
#define MAVLINK_MSG_ID_50250_LEN 2
#define MAVLINK_MSG_ID_50250_MIN_LEN 2

#define MAVLINK_MSG_ID_MAGOTHY_MISSION_REQUEST_CRC 50
#define MAVLINK_MSG_ID_50250_CRC 50
...
#define MAVLINK_MESSAGE_INFO_MAGOTHY_MISSION_REQUEST { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_magothy_mission_request_t, target_system) }, \
         { "chunk_index", NULL, MAVLINK_TYPE_UINT8_T, 0, 1, offsetof(mavlink_magothy_mission_request_t, chunk_index) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MAGOTHY_MISSION_REQUEST { \
...
static inline uint16_t mavlink_msg_magothy_mission_request_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, uint8_t chunk_index)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MAGOTHY_MISSION_REQUEST_LEN];
    _mav_put_uint8_t(buf, 0, target_system);
    _mav_put_uint8_t(buf, 1, chunk_index);
...
{
    return mavlink_msg_magothy_mission_request_pack(system_id, component_id, msg, magothy_mission_request->target_system, magothy_mission_request->chunk_index);
}
...
{
    return mavlink_msg_magothy_mission_request_pack_chan(system_id, component_id, chan, msg, magothy_mission_request->target_system, magothy_mission_request->chunk_index);
}
...
static inline void mavlink_msg_magothy_mission_request_send(mavlink_channel_t chan, uint8_t target_system, uint8_t chunk_index)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MAGOTHY_MISSION_REQUEST_LEN];
    _mav_put_uint8_t(buf, 0, target_system);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_magothy_mission_request_send(chan, magothy_mission_request->target_system, magothy_mission_request->chunk_index);
#else
 ...
 */
static inline void mavlink_msg_magothy_mission_request_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t chunk_index)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
