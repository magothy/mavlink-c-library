...
static void mavlink_test_magothy_low_bandwidth(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_magothy_low_bandwidth_t packet_in = {
        963497464,963497672,963497880,963498088,963498296,963498504,18483,18587,18691,18795,18899,19003,19107,19211,19315,3,70,137,204,963499856,19835,381.0,409.0,{ 437.0, 438.0, 439.0, 440.0 },21187
    };
    mavlink_magothy_low_bandwidth_t packet1, packet2;
        ...
        packet1.gps_spoofing_status_bitmask = packet_in.gps_spoofing_status_bitmask;
