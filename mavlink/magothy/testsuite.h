...
static void mavlink_test_magothy_mission_transfer(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_magothy_mission_transfer_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_magothy_mission_transfer_pack(system_id, component_id, &msg , packet1.target_system , packet1.session_id , packet1.chunk_index , packet1.num_chunk , packet1.crc16 , packet1.payload_len , packet1.payload );
    mavlink_msg_magothy_mission_transfer_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_magothy_mission_transfer_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.session_id , packet1.chunk_index , packet1.num_chunk , packet1.crc16 , packet1.payload_len , packet1.payload );
    mavlink_msg_magothy_mission_transfer_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_magothy_mission_transfer_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_magothy_mission_transfer_send(MAVLINK_COMM_1 , packet1.target_system , packet1.session_id , packet1.chunk_index , packet1.num_chunk , packet1.crc16 , packet1.payload_len , packet1.payload );
    mavlink_msg_magothy_mission_transfer_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
