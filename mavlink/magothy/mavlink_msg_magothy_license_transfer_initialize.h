...
#define MAVLINK_MSG_ID_MAGOTHY_LICENSE_TRANSFER_INITIALIZE_LEN 66
#define MAVLINK_MSG_ID_MAGOTHY_LICENSE_TRANSFER_INITIALIZE_MIN_LEN 66
#define MAVLINK_MSG_ID_50151_LEN 66
#define MAVLINK_MSG_ID_50151_MIN_LEN 66

#define MAVLINK_MSG_ID_MAGOTHY_LICENSE_TRANSFER_INITIALIZE_CRC 148
#define MAVLINK_MSG_ID_50151_CRC 148
...
static inline uint16_t mavlink_msg_magothy_license_transfer_initialize_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, uint8_t transfer_type, const char *product_key)
{
...
{
    return mavlink_msg_magothy_license_transfer_initialize_pack(system_id, component_id, msg, magothy_license_transfer_initialize->target_system, magothy_license_transfer_initialize->transfer_type, magothy_license_transfer_initialize->product_key);
}
...
{
    return mavlink_msg_magothy_license_transfer_initialize_pack_chan(system_id, component_id, chan, msg, magothy_license_transfer_initialize->target_system, magothy_license_transfer_initialize->transfer_type, magothy_license_transfer_initialize->product_key);
}
...
static inline void mavlink_msg_magothy_license_transfer_initialize_send(mavlink_channel_t chan, uint8_t target_system, uint8_t transfer_type, const char *product_key)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MAGOTHY_LICENSE_TRANSFER_INITIALIZE_LEN];
    _mav_put_uint8_t(buf, 0, target_system);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_magothy_license_transfer_initialize_send(chan, magothy_license_transfer_initialize->target_system, magothy_license_transfer_initialize->transfer_type, magothy_license_transfer_initialize->product_key);
#else
 ...
 */
static inline void mavlink_msg_magothy_license_transfer_initialize_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t transfer_type, const char *product_key)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
