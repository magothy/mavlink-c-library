...
#define MAVLINK_MSG_ID_MAGOTHY_MISSION_ACK_LEN 6
#define MAVLINK_MSG_ID_MAGOTHY_MISSION_ACK_MIN_LEN 6
#define MAVLINK_MSG_ID_50252_LEN 6
#define MAVLINK_MSG_ID_50252_MIN_LEN 6

#define MAVLINK_MSG_ID_MAGOTHY_MISSION_ACK_CRC 255
#define MAVLINK_MSG_ID_50252_CRC 255
...
#define MAVLINK_MESSAGE_INFO_MAGOTHY_MISSION_ACK { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_magothy_mission_ack_t, target_system) }, \
         { "chunk_index", NULL, MAVLINK_TYPE_UINT8_T, 0, 3, offsetof(mavlink_magothy_mission_ack_t, chunk_index) }, \
         { "num_chunk", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_magothy_mission_ack_t, num_chunk) }, \
         { "crc16", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_magothy_mission_ack_t, crc16) }, \
         { "result", NULL, MAVLINK_TYPE_UINT8_T, 0, 5, offsetof(mavlink_magothy_mission_ack_t, result) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MAGOTHY_MISSION_ACK { \
...
static inline uint16_t mavlink_msg_magothy_mission_ack_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, uint8_t chunk_index, uint8_t num_chunk, uint16_t crc16, uint8_t result)
{
...
{
    return mavlink_msg_magothy_mission_ack_pack(system_id, component_id, msg, magothy_mission_ack->target_system, magothy_mission_ack->chunk_index, magothy_mission_ack->num_chunk, magothy_mission_ack->crc16, magothy_mission_ack->result);
}
...
{
    return mavlink_msg_magothy_mission_ack_pack_chan(system_id, component_id, chan, msg, magothy_mission_ack->target_system, magothy_mission_ack->chunk_index, magothy_mission_ack->num_chunk, magothy_mission_ack->crc16, magothy_mission_ack->result);
}
...
static inline void mavlink_msg_magothy_mission_ack_send(mavlink_channel_t chan, uint8_t target_system, uint8_t chunk_index, uint8_t num_chunk, uint16_t crc16, uint8_t result)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MAGOTHY_MISSION_ACK_LEN];
    _mav_put_uint16_t(buf, 0, crc16);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_magothy_mission_ack_send(chan, magothy_mission_ack->target_system, magothy_mission_ack->chunk_index, magothy_mission_ack->num_chunk, magothy_mission_ack->crc16, magothy_mission_ack->result);
#else
 ...
 */
static inline void mavlink_msg_magothy_mission_ack_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t chunk_index, uint8_t num_chunk, uint16_t crc16, uint8_t result)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
