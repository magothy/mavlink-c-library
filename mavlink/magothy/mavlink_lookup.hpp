...
static const std::unordered_map<uint32_t, const char*> MAVLINK_MSG_ID_LOOKUP = {
    ...
    {50005, "MAGOTHY_PROTOBUF_PROXY"},
    {50006, "MAGOTHY_BEACON_DETECTION"},
    {50007, "MAGOTHY_TELEOP_SAFETY"},
...
static const std::unordered_map<uint32_t, const char*> MAVLINK_MAGOTHY_GPS_SPOOFING_LOOKUP = {
    ...
    {2, "MAGOTHY_GPS_SPOOFING_EVALUATED"},
    {4, "MAGOTHY_GPS_SPOOFING_DETECTED"},
    {8, "MAGOTHY_GPS_SPOOFING_MITIGATION_ENABLED"},
    {16, "MAGOTHY_GPS_SPOOFING_MITIGATION_ACTIVE"},
    {32, "MAGOTHY_GPS_SPOOFING_GGA_FRESH"},
    {64, "MAGOTHY_GPS_SPOOFING_RMC_FRESH"},
    {128, "MAGOTHY_GPS_SPOOFING_GST_FRESH"},
    {256, "MAGOTHY_GPS_SPOOFING_ATTITUDE_FRESH"},
    {512, "MAGOTHY_GPS_SPOOFING_ACCELERATION_FRESH"},
    {1024, "MAGOTHY_GPS_SPOOFING_ANGULAR_RATE_FRESH"},
    {2048, "MAGOTHY_GPS_SPOOFING_SPEED_FRESH"},
};
...
static const std::unordered_map<uint32_t, const char*> MAVLINK_MAV_CMD_LOOKUP = {
    ...
    {50212, "MAV_CMD_DO_MILLING"},
    {50213, "MAV_CMD_DO_SET_MILLING_POLYGON_VERTEX"},
