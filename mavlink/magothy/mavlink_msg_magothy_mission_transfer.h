...
#define MAVLINK_MSG_ID_MAGOTHY_MISSION_TRANSFER_CRC 37
#define MAVLINK_MSG_ID_50251_CRC 37

#define MAVLINK_MSG_MAGOTHY_MISSION_TRANSFER_FIELD_PAYLOAD_LEN 248
...
#define MAVLINK_MESSAGE_INFO_MAGOTHY_MISSION_TRANSFER { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_magothy_mission_transfer_t, target_system) }, \
         ...
         { "chunk_index", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_magothy_mission_transfer_t, chunk_index) }, \
         { "num_chunk", NULL, MAVLINK_TYPE_UINT8_T, 0, 5, offsetof(mavlink_magothy_mission_transfer_t, num_chunk) }, \
         { "crc16", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_magothy_mission_transfer_t, crc16) }, \
         { "payload_len", NULL, MAVLINK_TYPE_UINT8_T, 0, 6, offsetof(mavlink_magothy_mission_transfer_t, payload_len) }, \
         { "payload", NULL, MAVLINK_TYPE_UINT8_T, 248, 7, offsetof(mavlink_magothy_mission_transfer_t, payload) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MAGOTHY_MISSION_TRANSFER { \
...
static inline uint16_t mavlink_msg_magothy_mission_transfer_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, uint8_t session_id, uint8_t chunk_index, uint8_t num_chunk, uint16_t crc16, uint8_t payload_len, const uint8_t *payload)
{
...
{
    return mavlink_msg_magothy_mission_transfer_pack(system_id, component_id, msg, magothy_mission_transfer->target_system, magothy_mission_transfer->session_id, magothy_mission_transfer->chunk_index, magothy_mission_transfer->num_chunk, magothy_mission_transfer->crc16, magothy_mission_transfer->payload_len, magothy_mission_transfer->payload);
}
...
static inline void mavlink_msg_magothy_mission_transfer_send(mavlink_channel_t chan, uint8_t target_system, uint8_t session_id, uint8_t chunk_index, uint8_t num_chunk, uint16_t crc16, uint8_t payload_len, const uint8_t *payload)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MAGOTHY_MISSION_TRANSFER_LEN];
    _mav_put_uint16_t(buf, 0, crc16);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_magothy_mission_transfer_send(chan, magothy_mission_transfer->target_system, magothy_mission_transfer->session_id, magothy_mission_transfer->chunk_index, magothy_mission_transfer->num_chunk, magothy_mission_transfer->crc16, magothy_mission_transfer->payload_len, magothy_mission_transfer->payload);
#else
 ...
 */
static inline void mavlink_msg_magothy_mission_transfer_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t session_id, uint8_t chunk_index, uint8_t num_chunk, uint16_t crc16, uint8_t payload_len, const uint8_t *payload)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
